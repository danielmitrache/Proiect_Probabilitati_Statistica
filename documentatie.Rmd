...
# 4. Evenimente și Probabilități (Cerința 3)
...
* **N** = numărul total de încercări (retry-uri + prima încercare)
* **F** = numărul de eșecuri (failures) produse pe parcursul unei cereri
...
# 9. Inegalități Probabilistice (Cerința 8)
